...
function update_ExtractFunctionsLibrary!()
    ...
    ExtractLibFunction(:equilibrium, :q0, "-", dd -> dd.equilibrium.time_slice[].profiles_1d.q[1])
    ExtractLibFunction(:equilibrium, :q_min, "-", dd -> dd.equilibrium.time_slice[].global_quantities.q_min.value)
    ExtractLibFunction(:equilibrium, :li_3, "-", dd -> dd.equilibrium.time_slice[].global_quantities.li_3)
    ...
    ExtractLibFunction(:equilibrium, :α_t, "-", dd -> alpha_t(dd))
    ...
    ExtractLibFunction(:temperatures, :te_ped, "keV", dd -> @ddtime(dd.summary.local.pedestal.t_e.value) / 1E3)
    ExtractLibFunction(:temperatures, :ti_ped, "keV", dd -> @ddtime(dd.summary.local.pedestal.t_i_average.value) / 1E3)
    ExtractLibFunction(:temperatures, :te_sep, "keV", dd -> @ddtime(dd.summary.local.separatrix.t_e.value) / 1E3)
    ExtractLibFunction(:temperatures, :ti_sep, "keV", dd -> @ddtime(dd.summary.local.separatrix.t_i_average.value) / 1E3)
    ...
    ExtractLibFunction(:densities, :ne_sep, "m⁻³", dd -> @ddtime(dd.summary.local.separatrix.n_e.value))
    ...
    ExtractLibFunction(:densities, :zeff_sep, "-", dd -> @ddtime(dd.summary.local.separatrix.zeff.value))
    ...
    ExtractLibFunction(:exhaust, :PLH, "MW", dd -> scaling_L_to_H_power(dd;include_isotope=false,include_metallic_wall=false,include_∇B_drift=false) / 1E6)
    ExtractLibFunction(:exhaust, :PLH_FUSE, "MW", dd -> scaling_L_to_H_power(dd) / 1E6)
